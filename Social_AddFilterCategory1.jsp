...
<head>
<title>Add Filter Category Status Page</title>
...
AND IMPLICATIONS</span></a></h1>
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
        <h2 class="style2" style=" color:#D64F14">Add Filter Category Status..</h2>
        <p>
            ...
            <p class="style37 style7">Filter Category Already Exist..</p>							
							
							
				
                    </p>
			        <p>&nbsp;</p>
			        <p><a href="Social_AddFilterCategory.jsp" class="style15 style38">Back</a><a href="Social_AddFilterCategory.jsp" class="style8 style15"></a></p>
			        <p>
                      <%
			        ...
			        <p>&nbsp;</p>
			        <p><a href="Social_AddFilterCategory.jsp" class="style15 style38">Back</a></p>
			        <%
											 }
											 else
											 {
														...
														%><p class="style37 style7">Please Input Filter Category Name..</p>
			        <p class="style37">&nbsp;</p>
			        <a href="Social_AddFilterCategory.jsp" class="style15 style38">Back</a>
			        </p>
			        <%
