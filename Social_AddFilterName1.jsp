...
<head>
<title>Add Filter Status Page</title>
...
AND IMPLICATIONS</span></a></h1>
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
        <h2 class="style2" style=" color:#D64F14">Add Filter Status..</h2>
        <p>
			    ...
			    try{   
					...
					String category=request.getParameter("category");
						...
						FileInputStream fs1 = null;
			 			String query1="select * from filter  where category='"+category+"' and filter='"+filter+"' "; 
            ...
            <%							
				...
				%>
			<p><a href="Social_AddFilterName.jsp" class="style8">Back</a></p>
				<%
					...
					String strQuery2 = "insert into filter(category,filter) values('"+category+"','"+filter+"')";
